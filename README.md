...
## Installation
1. Clone the repository: `git clone https://github.com/abubakar508/ecommerce-services-api`
2. Navigate to the project directory: `cd ecommerce-services-api`
